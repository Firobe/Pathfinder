...
void outPut::init_outPut()
{
    ...
    shaders.loadProgram("Ressources/shaders/vertex.vs","Ressources/shaders/pixel.fs");
    glUseProgram(shaders._program);

    GLuint idUniformResolution = glGetUniformLocation(shaders._program, "resolution");
